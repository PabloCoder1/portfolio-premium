      ...
      <div className="z-10 mx-auto grid w-full max-w-6xl grid-cols-1 items-center gap-12 lg:grid-cols-2 lg:gap-8">
        ...
        >
          ...
          <p className="mb-8 max-w-lg text-lg text-gray-400">
            Apaixonado por criar <strong>sistemas escaláveis</strong>, automatizar fluxos complexos com <strong>RPA</strong> e transformar ideias em <strong>experiências digitais</strong> de alto impacto.
          </p>
          ...
          <div className="flex flex-col gap-4 sm:flex-row">
            ...
            <a
              href="./Pablo Lima dos santos.pdf"
              download
          ...
          <div className="relative h-72 w-72 sm:h-96 sm:w-96">
            ...
            <div className="absolute inset-0 rounded-full border-2 border-purple-500/50 p-2">
              <div className="relative h-full w-full overflow-hidden rounded-full bg-gray-900">
                {/* Substitua o src por "/IMG_0037.JPEG" para usar a foto pública */}
                <Image
                  src="/IMG_0037.JPEG"
            ...
            {/* Elementos flutuantes (Opcional, dá um charme) */}
            <motion.div 
              animate={{ y: [-10, 10, -10] }} 
